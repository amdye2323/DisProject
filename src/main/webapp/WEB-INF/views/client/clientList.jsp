                            ...
                            <div class="table-responsive container">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <c:forEach items="${list }" var="cli">                                                            
                                        <tr style="cursor:pointer" onclick="location.href='/board/get?bno=${cli.cnum}'">
                                            <td><c:out value="${cli.cnum }" /></td>
                                            <td>                                           
                                            <a class="move" href='<c:out value="${cli.cnum }" />'><c:out value="${cli.cname }" /> <b>[  
                                            <c:out value=""></c:out>  ]</b>
                                            </a>
                                            </td>
                                            <td><c:out value="${cli.cfield }" /></td>
                                            <td><c:out value="${cli.cscale }" /></td>
